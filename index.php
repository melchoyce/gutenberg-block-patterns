	...
	if ( function_exists( 'register_pattern' ) ) {
		...
		register_pattern(
			...
			array(
				...
				'content' => "<!-- wp:columns -->  <div class=\"wp-block-columns\"><!-- wp:column {\"width\":80} -->  <div class=\"wp-block-column\" style=\"flex-basis:80%\"><!-- wp:paragraph {\"customFontSize\":28,\"lineHeight\":1.5} -->  <p style=\"font-size:28px;line-height:1.5\" class=\"has-custom-lineheight\">Driving empathy maps and possibly surprise and delight. Target mobile-first design with the aim to build ROI.</p>  <!-- /wp:paragraph --></div>  <!-- /wp:column -->    <!-- wp:column {\"width\":33.33} -->  <div class=\"wp-block-column\" style=\"flex-basis:33.33%\"></div>  <!-- /wp:column --></div>  <!-- /wp:columns -->    <!-- wp:columns -->  <div class=\"wp-block-columns\"><!-- wp:column -->  <div class=\"wp-block-column\"><!-- wp:paragraph -->  <p>Informing innovation and then surprise and delight. Driving custom solutions and possibly think outside the box. Create awareness with a goal to funnel users. Lead relevant and engaging content with the possibility to infiltrate new markets.</p>  <!-- /wp:paragraph --></div>  <!-- /wp:column -->    <!-- wp:column -->  <div class=\"wp-block-column\"><!-- wp:paragraph -->  <p>Amplifying innovation with the possibility to target the low hanging fruit. Consider dark social but innovate. Creating a holistic approach in order to be on brand. Leading empathy maps but be CMSable. Repurposing branding and mobile-first design.</p>  <!-- /wp:paragraph --></div>  <!-- /wp:column --></div>  <!-- /wp:columns -->",
			)
		);
